...
var showAllPeeps = function(){
	...
	if(searchContents.length > 0){
		searchContents.removeChild("allPeeps");
	}
...
var showFamPeeps = function(){
	...
	if(familyContents.length > 0){
		familyContents.removeChild("allFamily");
	}
	var addUl = document.createElement("ul")
	addUl.setAttribute("data-role","listview");
	addUl.setAttribute("data-filter","true");
...
var showCowoPeeps = function(){
	...
	if(cowoContents.length > 0){
		cowoContents.removeChild("allcoWo");
	}
	var addUl = document.createElement("ul")
	addUl.setAttribute("data-role","listview");
	addUl.setAttribute("data-filter","true");
...
var showFriendPeeps = function(){
	...
	if(friendContents.length > 0){
		friendContents.removeChild("allfriends");
	}
	var addUl = document.createElement("ul")
	addUl.setAttribute("data-role","listview");
	addUl.setAttribute("data-filter","true");
